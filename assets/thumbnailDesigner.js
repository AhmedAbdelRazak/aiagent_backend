...
async function renderThumbnailOverlay({
	...
	const filters = [
		...
		"unsharp=5:5:0.7",
		`drawbox=x=0:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.12:t=fill`,
		`drawbox=x=iw*0.2:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.1:t=fill`,
		`drawbox=x=iw*0.4:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.08:t=fill`,
		`drawbox=x=iw*0.6:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.06:t=fill`,
		`drawbox=x=iw*0.8:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.04:t=fill`,
