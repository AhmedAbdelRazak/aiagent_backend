...
async function renderThumbnailOverlay({
	...
	const filters = [
		...
		"unsharp=5:5:0.7",
		`drawbox=x=0:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.02:t=fill`,
		`drawbox=x=iw*0.2:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.016:t=fill`,
		`drawbox=x=iw*0.4:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.012:t=fill`,
		`drawbox=x=iw*0.6:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.008:t=fill`,
		`drawbox=x=iw*0.8:y=0:w=iw*0.2:h=ih:color=${accentColor}@0.004:t=fill`,
		`drawbox=x=0:y=0:w=iw*0.018:h=ih:color=${accentColor}@0.4:t=fill`,
		`drawbox=x=0:y=0:w=iw:h=ih:color=${accentColor}@0.12:t=4`,
		"vignette=0.08",
	];
	if (hasText) {
		filters.push(
