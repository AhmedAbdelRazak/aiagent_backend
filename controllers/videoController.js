...
async function pickTrendingTopicFresh(category, language, country) {
	...
	const base = (a) =>
		`
Attempt ${a}:
Return JSON array of 10 trending ${category} titles (${CURRENT_MONTH_YEAR}${loc}), no hashtags, ≤70 chars.${langLine}`.trim();
